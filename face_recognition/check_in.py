"""
Capture the picture of a user. Show welcome message with apointment details, if face recognized. Show message otherwise.
...
if __name__ == '__main__':
    ...
    def handle_data():
        ...
        res = identify(file_path, args['DB_USER'], args['DB_PASSWORD'])
        if res is not None:
          queryString = f"select* from user where User_ID = '{str(res)}'"
